...
# def try_click_download_button(page, dest_path: Path) -> bool:
#     """
#     In case a future portal theme wires the button to a real file download
#     (rather than window.print()), still give it a shot first.
#     """
...
#                 method = "button"
#                 ok = try_click_download_button(page, dest)
#                 if not ok:
#                     method = "print"
